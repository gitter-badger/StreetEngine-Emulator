...
namespace StreetEngine.Engine.Network
{
    ...
    public class lobbyServer
    {
        ...
        public static String ip = EngineConfig.IniConfig.IniValues.h_lobby;
        public static Int32 port = EngineConfig.IniConfig.IniValues.p_lobby;
        ...
        public static void ServerOnListeningEvent()
        {
            try
            {
                evnt("lobby_server@" + ip + ":" + " server started");
            }
            catch (Exception ex) { error(ex.ToString()); }
        }
    }
